...
<CloudinaryImage
    src="projects/scriptease-ii/seii_vcezit.png"
    alt="A screenshot of the ScriptEase II visual code editor in four main panels, with scripting functions on the left and bottom right, and the story graph shown on the top right."
    caption="A screenshot of the ScriptEase II with scripting functions and the story graph."
/>
