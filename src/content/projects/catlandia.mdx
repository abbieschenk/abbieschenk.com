...
<CloudinaryImage
    src="projects/catlandia/convogame_ez0fvy"
    alt="A screenshot of the ConvoGame game conversation editor, showing the conversation tree and editor panel filled with some basic text from the Catlandia game."
/>
